...
#model choice, parametrization and fitting with Grid Search + SVC
from sklearn.model_selection import GridSearchCV
from sklearn.svm import SVC

param_grid={'C':[0.001,0.01,0.1,1,10,100],'gamma':[0.001,0.01,0.1,1,10,100]} #defininuje parametry modelu SVC ktore beda analizowane w postaci dictionary
