...
#model choice, parametrization and fitting with Pipeline + Grid Search + SVC
...
param_grid={'scaler':[MinMaxScaler(),None],'classifier__C':[0.001,0.01,0.1,1,10,100],'classifier__gamma':[0.001,0.01,0.1,1,10,100]} #defininuje parametry modelu SVC ktore beda analizowane w postaci dictionary
