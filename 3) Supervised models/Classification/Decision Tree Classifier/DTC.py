...
import os
import pydotplus
os.environ['PATH'] = os.environ['PATH']+';' + r'C:\Users\Nowak\anaconda3\Library\bin\graphviz'
export_graphviz(model, out_file="tree.dot", class_names=target_names,feature_names=feature_names, impurity=False, filled=True)
