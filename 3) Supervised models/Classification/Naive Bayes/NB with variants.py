...
#model choice, parametrization and fitting - Gaussian Naive Bayes
from sklearn.naive_bayes import GaussianNB
model = GaussianNB()
model.fit(X_train,y_train)

#model choice, parametrization and fitting - Bernoulli Naive Bayes
"""from sklearn.naive_bayes import BernoulliNB
model = BernoulliNB()
model.fit(X_train,y_train)"""

#model choice, parametrization and fitting - Multinomial Naive Bayes
