...
param_grid=[{'classifier':[KNeighborsClassifier()],'scaler':[StandardScaler(),None],'classifier__n_neighbors':[1,2,3,4,5]},{'classifier':[LogisticRegression()],'scaler':[StandardScaler(),None],'classifier__C':[0.001,0.01,0.1,1,10,100]},{'classifier':[LinearSVC()],'scaler':[StandardScaler(),None],'classifier__C':[0.001,0.01,0.1,1,10,100]},{'classifier':[SVC()],'scaler':[StandardScaler(),None],'classifier__C':[0.001,0.01,0.1,1,10,100]},{'classifier':[GaussianNB()],'scaler':[StandardScaler(),None]},{'classifier':[RandomForestClassifier()],'scaler':[StandardScaler(),None],'classifier__criterion':["gini","entropy"]}]
